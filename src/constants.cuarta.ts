...
export const cuartaData = {
  menu: [
    ...
    { id: "k1", cat: "DE LA COCINA", nombre: "Hamburguesa La Tercera", desc: "200g de carne, cheddar, bacon, cebolla caramelizada y salsa secreta.", precio: 5800, badges: ["MÁS PEDIDO"] },
  ...
  galeria: [
    ...
    { id: "g4", cat: "Comida", src: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800", alt: "Hamburguesa La Tercera" },
  ...
  usuario: {
    ...
    historial: [
      ...
      { fecha: "20/05/2025", desc: "Cumpleaños La Tercera", puntos: 110 },
    ],
  },
};
